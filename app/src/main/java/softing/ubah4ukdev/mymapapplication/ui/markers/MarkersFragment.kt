...
import softing.ubah4ukdev.mymapapplication.ui.UpdateObserver
import softing.ubah4ukdev.mymapapplication.ui.Updater
import softing.ubah4ukdev.mymapapplication.ui.edit.EditFragment
import softing.ubah4ukdev.mymapapplication.ui.markers.adapter.MarkerAdapter
import softing.ubah4ukdev.mymapapplication.ui.markers.base.BaseMarkersFragment
...
class MarkersFragment : BaseMarkersFragment(), Screen, MarkerAdapter.Delegate, UpdateObserver {
    ...
    private fun showActionsDialog(marker: MarkerDomain) {
        AlertDialog.Builder(requireContext())
            .setItems(resources.getStringArray(R.array.item_actions))
            { _, item ->
